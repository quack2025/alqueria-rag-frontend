  ...
  en: {
    translation: {
      ...
      chat: {
        ...
        creativeWelcomeDescription: 'Combines real study data with creative analysis. Always indicates what information comes from studies vs generated insights',
  ...
  es: {
    translation: {
      ...
      chat: {
        ...
        creativeWelcomeDescription: 'Combina datos reales de estudios con análisis creativos. Siempre indica qué información viene de estudios vs insights generados',
