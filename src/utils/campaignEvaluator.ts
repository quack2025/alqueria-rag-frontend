...
import { ECONOMIC_SEGMENTS } from '../data/colombiaKnowledgeBase';
...
export class CampaignEvaluator {
  ...
  private static generateAuthenticInsights(
    ...
    if (archetype === UnileverArchetype.BOGOTANA_PROFESIONAL) {
    ...
    } else if (archetype === UnileverArchetype.AMA_CASA_TRADICIONAL) {
    ...
    } else if (archetype === UnileverArchetype.COSTENA_EMPRENDEDORA) {
    ...
    } else if (archetype === UnileverArchetype.CALENA_MODERNA) {
    ...
    } else if (archetype === UnileverArchetype.PAISA_TRADICIONAL) {
    ...
    } else if (archetype === UnileverArchetype.MADRE_MODERNA) {
  ...
  private static generateAuthenticConcerns(
    ...
    if (concept.monthly_price) {
      ...
      if (archetype === UnileverArchetype.AMA_CASA_TRADICIONAL && pricePercentage > 4) {
  ...
  private static generateAuthenticSuggestions(
    ...
    if (archetype === UnileverArchetype.AMA_CASA_TRADICIONAL) {
    ...
    } else if (archetype === UnileverArchetype.BOGOTANA_PROFESIONAL) {
